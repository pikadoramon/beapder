...
from beapder.network.downloader.base import RenderDownloader
from beapder.network.response import Response
from beapder.utils.webdriver import WebDriverPool, PlaywrightDriver
...
class PlaywrightDownloader(RenderDownloader):
    ...
    def download(self, request) -> Response:
        ...
        try:
            ...
            if request.trace_id and response.trace_id is None:

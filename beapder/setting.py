...
ITEM_PIPELINES = [
    "beapder.pipelines.mysql_pipeline.MysqlPipeline",
    # "beapder.pipelines.mongo_pipeline.MongoPipeline",
...
# 下载
DOWNLOADER = "beapder.network.downloader.RequestsDownloader"
SESSION_DOWNLOADER = "beapder.network.downloader.RequestsSessionDownloader"
RENDER_DOWNLOADER = "beapder.network.downloader.SeleniumDownloader"
...
# 设置不带颜色的日志格式
LOG_FORMAT = "%(asctime)s|%(threadName)s|%(filename)s|%(funcName)s|line:%(lineno)d|%(levelname)s| %(message)s"
# 设置带有颜色的日志格式
...
# 当使用mixin时，控制不关闭爬虫
DONT_CLOSE_SPIDER = False
# 获取任务间隔
DOWNLOAD_IDLE_DELAY = 60
MAX_DEAL_REQUEST_COUNT = -1
MAX_IDLE_REQUEST_COUNT = 0

# 扩展路径
BEAPDER_EXTENSION_METRIC_EMITTER = "beapder.extensions.metrics_emitter.LogMetricsEmitter"
LOG_METRICS_EMITTER_INTERVAL = 3

MAX_REQUEST_BUFFER_COUNT = 100

DOWNLOAD_BUSY_DELAY = 5
DUMP_JSON_DISABLE_INDENT = True

# 设置job-point扩展
EXTENSIONS = []
REQUEST_JOB_POINT_CLASS = "beapder.extensions.job_points.DefaultJobPointExtension"
REQUEST_JOB_POINT_BACKEND = "queuelib.queue.FifoDiskQueue"
REQUEST_JOB_POINT_SERIALIZE = "pickle.dumps"
REQUEST_JOB_POINT_DESERIALIZE = "pickle.loads"
REQUEST_JOB_POINT_CONFIGS = {
    "path": None,
    "chunksize": 10000
}

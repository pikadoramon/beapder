# -*- coding: utf-8 -*-
"""
Created on 2023-09-11 17:03:39
---------
@summary:
...
@click.option("--args", "-a", help="全局参数指定", type=str, default="")
...
@click.option("--args", "-a", help="实例参数指定", type=str, default="")
def run(runner, args):
...
if __name__ == '__main__':
    ...
    # 通常该文件无需更改, 若需要更改请说明理由 @pikadoramon
    # 爬虫应用入口
    if sys.argv[1].find(" ") > -1 or sys.argv[1].find("\n") > -1:

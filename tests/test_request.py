...
from beapder import Request, Response
...
def test_from_text():
    ...
    resp = Response.from_text(text=text, url="http://beapder.com/#/README")
    print(resp.text)
    print(resp)
...
def test_to_dict():
    request = Request("https://www.baidu.com?a=1&b=2", data={"a": 1}, params="k=1", callback="test", task_id=1,
                      cookies={"a": 1})
